...
class Users(models.Model):
    ...
    ref_id = models.CharField(max_length=100, blank=True, null=True, verbose_name='Ref_id')
    count_ref = models.CharField(max_length=7, blank=True, null=True, verbose_name='Кол-во пригл')
    language = models.CharField(max_length=2, blank=True, null=True, verbose_name='Язык')
